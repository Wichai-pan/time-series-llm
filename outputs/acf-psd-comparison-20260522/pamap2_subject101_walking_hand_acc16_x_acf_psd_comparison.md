...
- Plot PNG: `reports/baseline_verification_20260522/pamap2_subject101_walking_hand_acc16_x_acf_psd_comparison.png`
- Plot PDF: `reports/baseline_verification_20260522/pamap2_subject101_walking_hand_acc16_x_acf_psd_comparison.pdf`
...
| `synthetic_mean_acf_peak_score` | `0.463114` |
...
| `synthetic_mean_psd_peak_power` | `0.590224` |
| `psd_peak_hz_abs_diff` | `0.000000` |
| `real_window_std_mean` | `0.554010` |
| `synthetic_window_std_mean` | `0.654079` |
| `synthetic_abs_max` | `5.335193` |
