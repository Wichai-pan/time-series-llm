...
- Plot PNG: `reports/latent_constraints_20260523/clip_minmax/running_acf_psd_comparison.png`
- Plot PDF: `reports/latent_constraints_20260523/clip_minmax/running_acf_psd_comparison.pdf`
...
| `synthetic_mean_acf_peak_score` | `0.411636` |
...
| `synthetic_mean_psd_peak_power` | `0.608403` |
| `psd_peak_hz_abs_diff` | `0.000000` |
| `real_window_std_mean` | `0.867915` |
| `synthetic_window_std_mean` | `0.801930` |
| `synthetic_abs_max` | `4.582770` |
