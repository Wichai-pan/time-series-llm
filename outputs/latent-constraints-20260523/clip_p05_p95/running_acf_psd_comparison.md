...
- Plot PNG: `reports/latent_constraints_20260523/clip_p05_p95/running_acf_psd_comparison.png`
- Plot PDF: `reports/latent_constraints_20260523/clip_p05_p95/running_acf_psd_comparison.pdf`
...
| `synthetic_mean_acf_peak_score` | `0.453054` |
...
| `synthetic_mean_psd_peak_power` | `0.456647` |
| `psd_peak_hz_abs_diff` | `0.000000` |
| `real_window_std_mean` | `0.867915` |
| `synthetic_window_std_mean` | `0.638164` |
| `synthetic_abs_max` | `2.652425` |
