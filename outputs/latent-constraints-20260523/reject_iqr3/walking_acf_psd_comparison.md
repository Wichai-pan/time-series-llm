...
- Plot PNG: `reports/latent_constraints_20260523/reject_iqr3/walking_acf_psd_comparison.png`
- Plot PDF: `reports/latent_constraints_20260523/reject_iqr3/walking_acf_psd_comparison.pdf`
...
| `synthetic_mean_acf_peak_score` | `0.424548` |
...
| `synthetic_mean_psd_peak_power` | `0.295156` |
| `psd_peak_hz_abs_diff` | `0.333333` |
| `real_window_std_mean` | `0.554010` |
| `synthetic_window_std_mean` | `0.537402` |
| `synthetic_abs_max` | `2.500443` |
