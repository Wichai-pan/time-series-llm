...
class SDForgerTuningBlock(TrainerBlock):
    ...
    def train(
        ...
        **kwargs,
        ...
        """
        model_id_or_path = model_id_or_path or self.model_id_or_path
        ...
        try:
            ...
            hf_dataset = hf_dataset.add_column(
                ...
                [
                    embeddings_to_text(
                        ...
                        text_template=sdforger_params.get("text_template", "fim_template"),
            ...
            if training_overrides:
                train_args.update(
                    {k: v for k, v in training_overrides.items() if k in train_args and v is not None}
                )
