#!/bin/bash
#SBATCH --job-name=sdforger-pamap2-walk-lbl
...
python -m fms_dgt.public \
  --task-paths ./tasks/public/time_series/pamap2_subject101_walking_hand_acc16_x_label_conditioned_univariate/task.yaml \
  --restart-generation
