#!/bin/bash
#SBATCH --job-name=sdforger-pamap2-run-u
...
mkdir -p "$HF_HOME" "$HUGGINGFACE_HUB_CACHE" "$TRANSFORMERS_CACHE" reports/baseline_verification_20260522
...
ls -la reports/baseline_verification_20260522/pamap2_subject101_running_hand_acc16_x_univariate_baseline_tsgbench_metrics.*
